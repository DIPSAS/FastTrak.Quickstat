...
SELECT cp.PersonId, 'Fx123456789' AS VarName, cp.ListItem, cp.CreatedAt, cp.ProbId, mni.ItemCode AS Caption,
...
WHERE ( mni.ItemCode LIKE 'F[123456789]%' ) ) agg WHERE OrderNo = 1
