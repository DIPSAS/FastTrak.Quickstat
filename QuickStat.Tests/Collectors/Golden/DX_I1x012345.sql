...
SELECT cp.PersonId, 'I1x012345' AS VarName, cp.ListItem, cp.CreatedAt, cp.ProbId, mni.ItemCode AS Caption,
...
WHERE ( mni.ItemCode LIKE 'I1[012345]%' ) ) agg WHERE OrderNo = 1
