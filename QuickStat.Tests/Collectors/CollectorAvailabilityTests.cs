...
/// </summary>
/// <remarks>
/// No collector in this repository's registry uses it yet - Phase 4 adds the two that inner-join
/// <c>KB.AntibioticResistance2</c> - so the mechanism is exercised with synthetic descriptors. It
/// is tested now, rather than with the feature, because Phase 4 should only have to add rows.
/// </remarks>
public class CollectorAvailabilityTests
{
    ...
    [Fact]
    public void EveryCatalogCollectorIsAvailableTodayBecauseNoneRequiresAnything()
    {
    ...
    public void AnUnavailableCollectorIsFilteredOutAndReported()
    {
        ...
        // Nothing in the real catalog is optional yet, so the run is clean ...
